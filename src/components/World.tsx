    ...
    <group position={pos} rotation-y={0.5}>
      {[[-1.6, 0], [1.6, 0]].map(([x], i) => (
        <group key={i} position={[x, 0, 0]}>
          ...
          </mesh>          <mesh castShadow position={[0, 1.25, 0.5]} rotation-x={-0.38}>
            <cylinderGeometry args={[0.06, 0.06, 2.7, 8]} />
            <meshStandardMaterial color={frame} roughness={0.8} />
          </mesh>
              ))}
  ...
  const chainlink = useMemo(() => makeChainlinkTexture(), []);
    ...
    <group>
      ...
      <group position={[-5.9, 0, -5.8]} rotation-y={0.7}>
        ...
        </mesh>        <mesh castShadow position={[-0.3, 0.12, 0.25]} rotation-x={1.35}>
      ...
      <group position={[7.4, 0, -11.6]} rotation-y={Math.PI}>
        ...
        <mesh castShadow position={[0, 0.72, -0.22]}>
          ...
          <meshStandardMaterial color="#7a4b2e" roughness={0.85} />
        </mesh>        <mesh castShadow position={[0.4, 0.53, 0.05]}>
